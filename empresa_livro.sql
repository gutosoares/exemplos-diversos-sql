...
CREATE TABLE Funcionario (
    ID_Func     int      NOT NULL auto_increment, -- Auto encremento de valores 
    ...
    CONSTRAINT ck_sexo CHECK (Sexo='M' or Sexo='F') -- Determino que o atributo sexo só receba valores M e F
);
